...
const Checkout = () => {
  ...
  const handleApplyVoucher = () => {
    ...
    if (voucherCode.toUpperCase() === "SQB10") {
      setAppliedVoucher({ code: "SQB10", discount: subtotal * 0.1 });
  ...
  const handleVerifyAndOrder = async () => {
    ...
    try {
      ...
      const createdOrderId = res?.data?.orderId || res?.data?.id;
      ...
      if (paymentMethod === "BANKING") {
        setShowQR(true);
        setIsOtpOpen(false);
        showToast("Please scan QR to complete payment", "info");
        return;
      }
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-2/3 space-y-8">
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-100">
              <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center">
                <span className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 mr-3 text-sm">
                  1
                </span>
          ...
          <div className="w-full lg:w-1/3">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 sticky top-8">
              ...
              {showQR && paymentMethod === "BANKING" && orderId && (
                <div className="mt-6 p-6 bg-white border rounded-2xl text-center">
                  ...
                  <button
                    ...
                    className="w-full relative bg-green-500 text-white font-bold py-3 rounded-xl hover:bg-green-600 transition-all shadow-lg shadow-green-200 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center overflow-hidden group/btn"
                  >
                    I have transferred
                  </button>
                  ...
                  <p className="font-bold text-blue-600">ORDER_{orderId}</p>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="text-xs font-bold text-green-700">
                          Code {appliedVoucher.code} Active
                        </p>
            ...
            <>
              ...
              >
                ...
                <p className="text-gray-500 text-center mb-6">
                  We've sent a 6-digit confirmation code to your email. Please
                  enter it below.
                </p>

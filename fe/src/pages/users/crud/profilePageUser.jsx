            ...
            <div className="md:w-1/3 p-8 bg-gray-50 border-r border-gray-100 flex flex-col items-center text-center">
              <div className="relative mb-4">
                ...
                <label
                  ...
                  className="absolute bottom-0 right-0 p-1.5 bg-blue-600 rounded-full text-white hover:bg-blue-700 transition-colors cursor-pointer"
                >
                  <Camera size={14} />
                </label>
                <input
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="phone"
                        value={
                          isEditing ? formData.phone : showValue(user.phone)
                        }
                        onChange={handleChange}
                        disabled={!isEditing}
                        placeholder={
                          isEditing ? "Enter phone number" : "Not set"
                        }
                        className={`block w-full pl-10 pr-3 py-2.5 sm:text-sm border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all ${
                          isEditing
                            ? "bg-white border-gray-300 text-gray-900 shadow-sm"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="address"
                        value={
                          isEditing ? formData.address : showValue(user.address)
                        }
                        onChange={handleChange}
                        disabled={!isEditing}
                        placeholder={
                          isEditing ? "Enter your address" : "Not set"
                        }
                        className={`block w-full pl-10 pr-3 py-2.5 sm:text-sm border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all ${
                          isEditing
                            ? "bg-white border-gray-300 text-gray-900 shadow-sm"
